...
public class NetworkUtil {
    ...
    public static <T> T callHttpReq(HttpMethod method, String url, String params, Map<String, String> headers, Class<T> cls)  throws HttpServerErrorException {
        //generate headers
    ...
    public static <T1, T2> T2 callHttpReq(HttpMethod method, String url, T1 params, Map<String, String> headers, Class<T2> cls) {
        HttpHeaders httpHeaders = generateHeaders(headers);
    ...
    private static <T> T callHttpReq(HttpMethod method, String url, HttpEntity httpEntity, Class<T> cls) throws HttpServerErrorException{
