...
public class BarcodeUtil {
    ...
    public static String encode(String content, int width, int height,String iconImagePath, String qrcodeImagePath,boolean hasFiller) {
        try {
            ...
            if(width<260||height<260){
                width = BarcodeUtil.WIDTH;
                height = BarcodeUtil.HEIGHT;
            }
            ImageIO.write( genBarcode(content, width, height, iconImagePath, hasFiller), "png", new File(qrcodeImagePath));
    ...
    public static void main(String[] args) {
        ...
        String codePath = "C:/Users/rick/Desktop/"+System.currentTimeMillis()+".png";

        /**
         * 测试方法入口
         */
        BarcodeUtil.encode("项目：晚餐定制",300, 300, codeIconPath, codePath,false);
    }
}
